...
if (Authenticator::authenticated()) {
    ...
    <br>
    <div>User name</div>
    <input id="login_user_handle" class="w3-input" type="text">
    <br>
    <div>Password</div>
    <input id="login_password" class="w3-input" type="password">
    <div style="color: red;"><?php echo @$_GET["loginMessage"]; ?></div>
    <h1>Register</h1>
    <br>
    <div>User name</div>
    <input id="register_user_handle" class="w3-input" type="text">
    <br>
    <div>Password</div>
    <input id="register_password" class="w3-input" type="password">
    <br>
    <div>Name</div>
    <input id="register_name" class="w3-input" type="text">
    <br>
    <div>Timezone</div>
    <div class="w3-dropdown-hover w3-light-grey" style="margin-right: 15px;">
        ...
        <div class="w3-dropdown-content w3-bar-block w3-border">
            <?php \Kelvinho\Virus\map(Timezone::getDescriptions(), function ($description, $timezone) { ?>
    ...
    <script type="application/javascript">
        ...
        let timezone = 0;
        const timezones = {
            <?php echo join(",", \Kelvinho\Virus\map(Timezone::getDescriptions(), function ($description, $offset) {
