...
?>
<label for="duration">Duration</label><select id="duration" class="w3-select" name="option" style="padding: 10px;" <?php echo $attack->getStatus() === \Kelvinho\Virus\Attack\AttackBase::STATUS_EXECUTED ? "disabled" : ""; ?>>
