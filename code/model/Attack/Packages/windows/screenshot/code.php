...
move "%~pd0scst.exe" "%~pd0..\..\utils\scst.exe"
            ...
            case "code": //@formatter:off ?>
// reference
// https://gallery.technet.microsoft.com/scriptcenter/eeff544a-f690-4f6b-a586-11eea6fc5eb8

// this is taken from https://github.com/npocmaka/batch.scripts/blob/master/hybrids/.net/c/screenCapture.bat, which
// is taken from https://superuser.com/questions/75614/take-a-screen-shot-from-command-line-in-windows/943947
...
public class ScreenCapture {
	...
	Console.WriteLine("     with a title which will put on focus and captured.");
